...
@DatabaseTable(tableName = "miembrosdow")
public class memberdownload {
    @DatabaseField(generatedId = true)
    private int id;
    //este field es el id que genera firebase, cuando
    // se guardan los datos de un miembro en la base de datos real time de firebase
    @DatabaseField
    String keynode ;
    @DatabaseField
    String fecha ;
    ...
    @DatabaseField
    boolean trasladoserverlocal;
    public memberdownload(){
    ...
    public boolean getTrasladadoserverlocal(){
        return trasladoserverlocal;
    }
    ...
    public void setTrasladoserverlocal(boolean trasladoserverlocal){
        this.trasladoserverlocal = trasladoserverlocal;
    }
